...
80103804:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint*)sp = (uint)trapret;
80103807:	c7 40 14 64 59 10 80 	movl   $0x80105964,0x14(%eax)
  p->context = (struct context*)sp;
...
801041f3:	68 43 7c 10 80       	push   $0x80107c43
...
80104be4:	68 f8 78 10 80       	push   $0x801078f8
...
80104bfc:	68 f7 78 10 80       	push   $0x801078f7
...
80104c11:	68 eb 78 10 80       	push   $0x801078eb
...
80104c2f:	68 fa 78 10 80       	push   $0x801078fa
80104c34:	e8 57 b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104c39:	83 ec 0c             	sub    $0xc,%esp
80104c3c:	68 dc 78 10 80       	push   $0x801078dc
...
8010502d:	58                   	pop    %eax
8010502e:	5a                   	pop    %edx
8010502f:	68 f8 78 10 80       	push   $0x801078f8
...
80105048:	68 f7 78 10 80       	push   $0x801078f7
...
80105882:	e8 19 f1 ff ff       	call   801049a0 <argptr>
    *valid = 1;
80105887:	8b 45 f4             	mov    -0xc(%ebp),%eax
    // Checking, is VA is valid or invalid
    if(argptr(0, (void*) &vpn, sizeof(*vpn)) < 0) {
8010588a:	83 c4 0c             	add    $0xc,%esp
    *valid = 1;
8010588d:	c7 00 01 00 00 00    	movl   $0x1,(%eax)
    if(argptr(0, (void*) &vpn, sizeof(*vpn)) < 0) {
80105893:	8d 45 f0             	lea    -0x10(%ebp),%eax
80105896:	6a 04                	push   $0x4
...
801058a5:	78 50                	js     801058f7 <sys_v2paddr+0x87>
...
801058a7:	e8 b4 e0 ff ff       	call   80103960 <myproc>
...
801058ae:	8b 45 f0             	mov    -0x10(%ebp),%eax
    ...
    if(!(*PDE & PTE_P)) {
801058b1:	8b 52 04             	mov    0x4(%edx),%edx
    pde_t *PDE = &cr3[PDX(vpn)];  // Getting the page directory entry from the VA
801058b4:	89 c1                	mov    %eax,%ecx
801058b6:	c1 e9 16             	shr    $0x16,%ecx
    if(!(*PDE & PTE_P)) {
801058b9:	8b 14 8a             	mov    (%edx,%ecx,4),%edx
801058bc:	f6 c2 01             	test   $0x1,%dl
801058bf:	74 5b                	je     8010591c <sys_v2paddr+0xac>
        cprintf("Page directory entry not present for virtual address : 0x%x\n", (*vpn));
        *valid = 0;
        return -1;
    }
   if(!(*PDE & PTE_U)) {
801058c1:	f6 c2 04             	test   $0x4,%dl
801058c4:	74 62                	je     80105928 <sys_v2paddr+0xb8>
        *valid = 0;
        return -1;
    }
...
801058c6:	89 c1                	mov    %eax,%ecx
    pde_t *pgtab = (pte_t *)P2V(PTE_ADDR(*PDE));  // Getting base of the page table from page directory entry
801058c8:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
    pde_t *PTE = &pgtab[PTX(vpn)];  // Getting the page table entry obtained from the VA
801058ce:	c1 e9 0c             	shr    $0xc,%ecx
801058d1:	81 e1 ff 03 00 00    	and    $0x3ff,%ecx

    // Checking if page table entry is not present or can't be accessable
    if(!(*PTE & PTE_P)) {
801058d7:	8b 94 8a 00 00 00 80 	mov    -0x80000000(%edx,%ecx,4),%edx
801058de:	f6 c2 01             	test   $0x1,%dl
801058e1:	74 5d                	je     80105940 <sys_v2paddr+0xd0>
        cprintf("Page table entry not present for virtual address : 0x%x\n", (*vpn));
        *valid = 0;
        return -1;
    }
    if(!(*PTE & PTE_U)) {
801058e3:	f6 c2 04             	test   $0x4,%dl
801058e6:	74 4c                	je     80105934 <sys_v2paddr+0xc4>
    }
...
801058e8:	c9                   	leave  
    return (ppn + PTE_FLAGS(vpn));  // Returning the Physical Address
801058e9:	25 ff 0f 00 00       	and    $0xfff,%eax
    ppn = PTE_ADDR(*PTE);
801058ee:	81 e2 00 f0 ff ff    	and    $0xfffff000,%edx
    return (ppn + PTE_FLAGS(vpn));  // Returning the Physical Address
801058f4:	09 d0                	or     %edx,%eax
}
801058f6:	c3                   	ret    
        cprintf("Invalid virtual address : 0x%x\n", (*vpn));
801058f7:	8b 45 f0             	mov    -0x10(%ebp),%eax
801058fa:	83 ec 08             	sub    $0x8,%esp
801058fd:	ff 30                	pushl  (%eax)
801058ff:	68 40 79 10 80       	push   $0x80107940
        cprintf("Page table entry can't be accessable for virtual address : 0x%x\n", (*vpn));
80105904:	e8 a7 ad ff ff       	call   801006b0 <cprintf>
        *valid = 0;
80105909:	8b 45 f4             	mov    -0xc(%ebp),%eax
        return -1;
8010590c:	83 c4 10             	add    $0x10,%esp
        *valid = 0;
8010590f:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
        return -1;
...
8010591f:	ff 30                	pushl  (%eax)
80105921:	68 60 79 10 80       	push   $0x80107960
80105926:	eb dc                	jmp    80105904 <sys_v2paddr+0x94>
        cprintf("Page directory entry can't be accessable for virtual address : 0x%x\n", (*vpn));
80105928:	83 ec 08             	sub    $0x8,%esp
8010592b:	ff 30                	pushl  (%eax)
8010592d:	68 a0 79 10 80       	push   $0x801079a0
80105932:	eb d0                	jmp    80105904 <sys_v2paddr+0x94>
        cprintf("Page table entry can't be accessable for virtual address : 0x%x\n", (*vpn));
80105934:	83 ec 08             	sub    $0x8,%esp
80105937:	ff 30                	pushl  (%eax)
80105939:	68 24 7a 10 80       	push   $0x80107a24
8010593e:	eb c4                	jmp    80105904 <sys_v2paddr+0x94>
        cprintf("Page table entry not present for virtual address : 0x%x\n", (*vpn));
80105940:	83 ec 08             	sub    $0x8,%esp
80105943:	ff 30                	pushl  (%eax)
80105945:	68 e8 79 10 80       	push   $0x801079e8
8010594a:	eb b8                	jmp    80105904 <sys_v2paddr+0x94>
...
801059be:	00 00 ef 
  initlock(&tickslock, "time");
801059c1:	68 65 7a 10 80       	push   $0x80107a65
...
80105a44:	3e ff 24 85 0c 7b 10 	notrack jmp *-0x7fef84f4(,%eax,4)
80105a4b:	80 
    lapiceoi();
    break;
...
80105aa1:	68 c8 7a 10 80       	push   $0x80107ac8
...
80105bbc:	68 70 7a 10 80       	push   $0x80107a70
...
80105c58:	68 94 7a 10 80       	push   $0x80107a94
80105c5d:	e8 4e aa ff ff       	call   801006b0 <cprintf>
      panic("trap");
80105c62:	83 c4 14             	add    $0x14,%esp
80105c65:	68 6a 7a 10 80       	push   $0x80107a6a
...
80105d63:	be 76 00 00 00       	mov    $0x76,%esi
  for(p="xv6...\n"; *p; p++)
80105d68:	bb 8c 7b 10 80       	mov    $0x80107b8c,%ebx
  ioapicenable(IRQ_COM1, 0);
...
80105dfb:	6a 00                	push   $0x0
  jmp alltraps
80105dfd:	e9 4a fb ff ff       	jmp    8010594c <alltraps>
...
80105e04:	6a 01                	push   $0x1
  jmp alltraps
80105e06:	e9 41 fb ff ff       	jmp    8010594c <alltraps>
...
80105e0d:	6a 02                	push   $0x2
  jmp alltraps
80105e0f:	e9 38 fb ff ff       	jmp    8010594c <alltraps>
...
80105e16:	6a 03                	push   $0x3
  jmp alltraps
80105e18:	e9 2f fb ff ff       	jmp    8010594c <alltraps>
...
80105e1f:	6a 04                	push   $0x4
  jmp alltraps
80105e21:	e9 26 fb ff ff       	jmp    8010594c <alltraps>
...
80105e28:	6a 05                	push   $0x5
  jmp alltraps
80105e2a:	e9 1d fb ff ff       	jmp    8010594c <alltraps>
...
80105e31:	6a 06                	push   $0x6
  jmp alltraps
80105e33:	e9 14 fb ff ff       	jmp    8010594c <alltraps>
...
80105e3a:	6a 07                	push   $0x7
  jmp alltraps
80105e3c:	e9 0b fb ff ff       	jmp    8010594c <alltraps>
...
80105e41:	6a 08                	push   $0x8
  jmp alltraps
80105e43:	e9 04 fb ff ff       	jmp    8010594c <alltraps>
...
80105e4a:	6a 09                	push   $0x9
  jmp alltraps
80105e4c:	e9 fb fa ff ff       	jmp    8010594c <alltraps>
...
80105e51:	6a 0a                	push   $0xa
  jmp alltraps
80105e53:	e9 f4 fa ff ff       	jmp    8010594c <alltraps>
...
80105e58:	6a 0b                	push   $0xb
  jmp alltraps
80105e5a:	e9 ed fa ff ff       	jmp    8010594c <alltraps>
...
80105e5f:	6a 0c                	push   $0xc
  jmp alltraps
80105e61:	e9 e6 fa ff ff       	jmp    8010594c <alltraps>
...
80105e66:	6a 0d                	push   $0xd
  jmp alltraps
80105e68:	e9 df fa ff ff       	jmp    8010594c <alltraps>
...
80105e7f:	6a 10                	push   $0x10
  jmp alltraps
80105e81:	e9 c6 fa ff ff       	jmp    8010594c <alltraps>
...
80105e8f:	6a 12                	push   $0x12
  jmp alltraps
80105e91:	e9 b6 fa ff ff       	jmp    8010594c <alltraps>
...
80105e98:	6a 13                	push   $0x13
  jmp alltraps
80105e9a:	e9 ad fa ff ff       	jmp    8010594c <alltraps>
...
80105ea1:	6a 14                	push   $0x14
  jmp alltraps
80105ea3:	e9 a4 fa ff ff       	jmp    8010594c <alltraps>
...
80105eaa:	6a 15                	push   $0x15
  jmp alltraps
80105eac:	e9 9b fa ff ff       	jmp    8010594c <alltraps>
...
80105eb3:	6a 16                	push   $0x16
  jmp alltraps
80105eb5:	e9 92 fa ff ff       	jmp    8010594c <alltraps>
...
80105ebc:	6a 17                	push   $0x17
  jmp alltraps
80105ebe:	e9 89 fa ff ff       	jmp    8010594c <alltraps>
...
80105ec5:	6a 18                	push   $0x18
  jmp alltraps
80105ec7:	e9 80 fa ff ff       	jmp    8010594c <alltraps>
...
80105ece:	6a 19                	push   $0x19
  jmp alltraps
80105ed0:	e9 77 fa ff ff       	jmp    8010594c <alltraps>
...
80105ed7:	6a 1a                	push   $0x1a
  jmp alltraps
80105ed9:	e9 6e fa ff ff       	jmp    8010594c <alltraps>
...
80105ee0:	6a 1b                	push   $0x1b
  jmp alltraps
80105ee2:	e9 65 fa ff ff       	jmp    8010594c <alltraps>
...
80105ee9:	6a 1c                	push   $0x1c
  jmp alltraps
80105eeb:	e9 5c fa ff ff       	jmp    8010594c <alltraps>
...
80105ef2:	6a 1d                	push   $0x1d
  jmp alltraps
80105ef4:	e9 53 fa ff ff       	jmp    8010594c <alltraps>
...
80105efb:	6a 1e                	push   $0x1e
  jmp alltraps
80105efd:	e9 4a fa ff ff       	jmp    8010594c <alltraps>
...
80105f04:	6a 1f                	push   $0x1f
  jmp alltraps
80105f06:	e9 41 fa ff ff       	jmp    8010594c <alltraps>
...
80105f0d:	6a 20                	push   $0x20
  jmp alltraps
80105f0f:	e9 38 fa ff ff       	jmp    8010594c <alltraps>
...
80105f16:	6a 21                	push   $0x21
  jmp alltraps
80105f18:	e9 2f fa ff ff       	jmp    8010594c <alltraps>
...
80105f1f:	6a 22                	push   $0x22
  jmp alltraps
80105f21:	e9 26 fa ff ff       	jmp    8010594c <alltraps>
...
80105f28:	6a 23                	push   $0x23
  jmp alltraps
80105f2a:	e9 1d fa ff ff       	jmp    8010594c <alltraps>
...
80105f31:	6a 24                	push   $0x24
  jmp alltraps
80105f33:	e9 14 fa ff ff       	jmp    8010594c <alltraps>
...
80105f3a:	6a 25                	push   $0x25
  jmp alltraps
80105f3c:	e9 0b fa ff ff       	jmp    8010594c <alltraps>
...
80105f43:	6a 26                	push   $0x26
  jmp alltraps
80105f45:	e9 02 fa ff ff       	jmp    8010594c <alltraps>
...
80105f4c:	6a 27                	push   $0x27
  jmp alltraps
80105f4e:	e9 f9 f9 ff ff       	jmp    8010594c <alltraps>
...
80105f55:	6a 28                	push   $0x28
  jmp alltraps
80105f57:	e9 f0 f9 ff ff       	jmp    8010594c <alltraps>
...
80105f5e:	6a 29                	push   $0x29
  jmp alltraps
80105f60:	e9 e7 f9 ff ff       	jmp    8010594c <alltraps>
...
80105f67:	6a 2a                	push   $0x2a
  jmp alltraps
80105f69:	e9 de f9 ff ff       	jmp    8010594c <alltraps>
...
80105f70:	6a 2b                	push   $0x2b
  jmp alltraps
80105f72:	e9 d5 f9 ff ff       	jmp    8010594c <alltraps>
...
80105f79:	6a 2c                	push   $0x2c
  jmp alltraps
80105f7b:	e9 cc f9 ff ff       	jmp    8010594c <alltraps>
...
80105f82:	6a 2d                	push   $0x2d
  jmp alltraps
80105f84:	e9 c3 f9 ff ff       	jmp    8010594c <alltraps>
...
80105f8b:	6a 2e                	push   $0x2e
  jmp alltraps
80105f8d:	e9 ba f9 ff ff       	jmp    8010594c <alltraps>
...
80105f94:	6a 2f                	push   $0x2f
  jmp alltraps
80105f96:	e9 b1 f9 ff ff       	jmp    8010594c <alltraps>
...
80105f9d:	6a 30                	push   $0x30
  jmp alltraps
80105f9f:	e9 a8 f9 ff ff       	jmp    8010594c <alltraps>
...
80105fa6:	6a 31                	push   $0x31
  jmp alltraps
80105fa8:	e9 9f f9 ff ff       	jmp    8010594c <alltraps>
...
80105faf:	6a 32                	push   $0x32
  jmp alltraps
80105fb1:	e9 96 f9 ff ff       	jmp    8010594c <alltraps>
...
80105fb8:	6a 33                	push   $0x33
  jmp alltraps
80105fba:	e9 8d f9 ff ff       	jmp    8010594c <alltraps>
...
80105fc1:	6a 34                	push   $0x34
  jmp alltraps
80105fc3:	e9 84 f9 ff ff       	jmp    8010594c <alltraps>
...
80105fca:	6a 35                	push   $0x35
  jmp alltraps
80105fcc:	e9 7b f9 ff ff       	jmp    8010594c <alltraps>
...
80105fd3:	6a 36                	push   $0x36
  jmp alltraps
80105fd5:	e9 72 f9 ff ff       	jmp    8010594c <alltraps>
...
80105fdc:	6a 37                	push   $0x37
  jmp alltraps
80105fde:	e9 69 f9 ff ff       	jmp    8010594c <alltraps>
...
80105fe5:	6a 38                	push   $0x38
  jmp alltraps
80105fe7:	e9 60 f9 ff ff       	jmp    8010594c <alltraps>
...
80105fee:	6a 39                	push   $0x39
  jmp alltraps
80105ff0:	e9 57 f9 ff ff       	jmp    8010594c <alltraps>
...
80105ff7:	6a 3a                	push   $0x3a
  jmp alltraps
80105ff9:	e9 4e f9 ff ff       	jmp    8010594c <alltraps>
...
80106000:	6a 3b                	push   $0x3b
  jmp alltraps
80106002:	e9 45 f9 ff ff       	jmp    8010594c <alltraps>
...
80106009:	6a 3c                	push   $0x3c
  jmp alltraps
8010600b:	e9 3c f9 ff ff       	jmp    8010594c <alltraps>
...
80106012:	6a 3d                	push   $0x3d
  jmp alltraps
80106014:	e9 33 f9 ff ff       	jmp    8010594c <alltraps>
...
8010601b:	6a 3e                	push   $0x3e
  jmp alltraps
8010601d:	e9 2a f9 ff ff       	jmp    8010594c <alltraps>
...
80106024:	6a 3f                	push   $0x3f
  jmp alltraps
80106026:	e9 21 f9 ff ff       	jmp    8010594c <alltraps>
...
8010602d:	6a 40                	push   $0x40
  jmp alltraps
8010602f:	e9 18 f9 ff ff       	jmp    8010594c <alltraps>
...
80106036:	6a 41                	push   $0x41
  jmp alltraps
80106038:	e9 0f f9 ff ff       	jmp    8010594c <alltraps>
...
8010603f:	6a 42                	push   $0x42
  jmp alltraps
80106041:	e9 06 f9 ff ff       	jmp    8010594c <alltraps>
...
80106048:	6a 43                	push   $0x43
  jmp alltraps
8010604a:	e9 fd f8 ff ff       	jmp    8010594c <alltraps>
...
80106051:	6a 44                	push   $0x44
  jmp alltraps
80106053:	e9 f4 f8 ff ff       	jmp    8010594c <alltraps>
...
8010605a:	6a 45                	push   $0x45
  jmp alltraps
8010605c:	e9 eb f8 ff ff       	jmp    8010594c <alltraps>
...
80106063:	6a 46                	push   $0x46
  jmp alltraps
80106065:	e9 e2 f8 ff ff       	jmp    8010594c <alltraps>
...
8010606c:	6a 47                	push   $0x47
  jmp alltraps
8010606e:	e9 d9 f8 ff ff       	jmp    8010594c <alltraps>
...
80106075:	6a 48                	push   $0x48
  jmp alltraps
80106077:	e9 d0 f8 ff ff       	jmp    8010594c <alltraps>
...
8010607e:	6a 49                	push   $0x49
  jmp alltraps
80106080:	e9 c7 f8 ff ff       	jmp    8010594c <alltraps>
...
80106087:	6a 4a                	push   $0x4a
  jmp alltraps
80106089:	e9 be f8 ff ff       	jmp    8010594c <alltraps>
...
80106090:	6a 4b                	push   $0x4b
  jmp alltraps
80106092:	e9 b5 f8 ff ff       	jmp    8010594c <alltraps>
...
80106099:	6a 4c                	push   $0x4c
  jmp alltraps
8010609b:	e9 ac f8 ff ff       	jmp    8010594c <alltraps>
...
801060a2:	6a 4d                	push   $0x4d
  jmp alltraps
801060a4:	e9 a3 f8 ff ff       	jmp    8010594c <alltraps>
...
801060ab:	6a 4e                	push   $0x4e
  jmp alltraps
801060ad:	e9 9a f8 ff ff       	jmp    8010594c <alltraps>
...
801060b4:	6a 4f                	push   $0x4f
  jmp alltraps
801060b6:	e9 91 f8 ff ff       	jmp    8010594c <alltraps>
...
801060bd:	6a 50                	push   $0x50
  jmp alltraps
801060bf:	e9 88 f8 ff ff       	jmp    8010594c <alltraps>
...
801060c6:	6a 51                	push   $0x51
  jmp alltraps
801060c8:	e9 7f f8 ff ff       	jmp    8010594c <alltraps>
...
801060cf:	6a 52                	push   $0x52
  jmp alltraps
801060d1:	e9 76 f8 ff ff       	jmp    8010594c <alltraps>
...
801060d8:	6a 53                	push   $0x53
  jmp alltraps
801060da:	e9 6d f8 ff ff       	jmp    8010594c <alltraps>
...
801060e1:	6a 54                	push   $0x54
  jmp alltraps
801060e3:	e9 64 f8 ff ff       	jmp    8010594c <alltraps>
...
801060ea:	6a 55                	push   $0x55
  jmp alltraps
801060ec:	e9 5b f8 ff ff       	jmp    8010594c <alltraps>
...
801060f3:	6a 56                	push   $0x56
  jmp alltraps
801060f5:	e9 52 f8 ff ff       	jmp    8010594c <alltraps>
...
801060fc:	6a 57                	push   $0x57
  jmp alltraps
801060fe:	e9 49 f8 ff ff       	jmp    8010594c <alltraps>
...
80106105:	6a 58                	push   $0x58
  jmp alltraps
80106107:	e9 40 f8 ff ff       	jmp    8010594c <alltraps>
...
8010610e:	6a 59                	push   $0x59
  jmp alltraps
80106110:	e9 37 f8 ff ff       	jmp    8010594c <alltraps>
...
80106117:	6a 5a                	push   $0x5a
  jmp alltraps
80106119:	e9 2e f8 ff ff       	jmp    8010594c <alltraps>
...
80106120:	6a 5b                	push   $0x5b
  jmp alltraps
80106122:	e9 25 f8 ff ff       	jmp    8010594c <alltraps>
...
80106129:	6a 5c                	push   $0x5c
  jmp alltraps
8010612b:	e9 1c f8 ff ff       	jmp    8010594c <alltraps>
...
80106132:	6a 5d                	push   $0x5d
  jmp alltraps
80106134:	e9 13 f8 ff ff       	jmp    8010594c <alltraps>
...
8010613b:	6a 5e                	push   $0x5e
  jmp alltraps
8010613d:	e9 0a f8 ff ff       	jmp    8010594c <alltraps>
...
80106144:	6a 5f                	push   $0x5f
  jmp alltraps
80106146:	e9 01 f8 ff ff       	jmp    8010594c <alltraps>
...
8010614d:	6a 60                	push   $0x60
  jmp alltraps
8010614f:	e9 f8 f7 ff ff       	jmp    8010594c <alltraps>
...
80106156:	6a 61                	push   $0x61
  jmp alltraps
80106158:	e9 ef f7 ff ff       	jmp    8010594c <alltraps>
...
8010615f:	6a 62                	push   $0x62
  jmp alltraps
80106161:	e9 e6 f7 ff ff       	jmp    8010594c <alltraps>
...
80106168:	6a 63                	push   $0x63
  jmp alltraps
8010616a:	e9 dd f7 ff ff       	jmp    8010594c <alltraps>
...
80106171:	6a 64                	push   $0x64
  jmp alltraps
80106173:	e9 d4 f7 ff ff       	jmp    8010594c <alltraps>
...
8010617a:	6a 65                	push   $0x65
  jmp alltraps
8010617c:	e9 cb f7 ff ff       	jmp    8010594c <alltraps>
...
80106183:	6a 66                	push   $0x66
  jmp alltraps
80106185:	e9 c2 f7 ff ff       	jmp    8010594c <alltraps>
...
8010618c:	6a 67                	push   $0x67
  jmp alltraps
8010618e:	e9 b9 f7 ff ff       	jmp    8010594c <alltraps>
...
80106195:	6a 68                	push   $0x68
  jmp alltraps
80106197:	e9 b0 f7 ff ff       	jmp    8010594c <alltraps>
...
8010619e:	6a 69                	push   $0x69
  jmp alltraps
801061a0:	e9 a7 f7 ff ff       	jmp    8010594c <alltraps>
...
801061a7:	6a 6a                	push   $0x6a
  jmp alltraps
801061a9:	e9 9e f7 ff ff       	jmp    8010594c <alltraps>
...
801061b0:	6a 6b                	push   $0x6b
  jmp alltraps
801061b2:	e9 95 f7 ff ff       	jmp    8010594c <alltraps>
...
801061b9:	6a 6c                	push   $0x6c
  jmp alltraps
801061bb:	e9 8c f7 ff ff       	jmp    8010594c <alltraps>
...
801061c2:	6a 6d                	push   $0x6d
  jmp alltraps
801061c4:	e9 83 f7 ff ff       	jmp    8010594c <alltraps>
...
801061cb:	6a 6e                	push   $0x6e
  jmp alltraps
801061cd:	e9 7a f7 ff ff       	jmp    8010594c <alltraps>
...
801061d4:	6a 6f                	push   $0x6f
  jmp alltraps
801061d6:	e9 71 f7 ff ff       	jmp    8010594c <alltraps>
...
801061dd:	6a 70                	push   $0x70
  jmp alltraps
801061df:	e9 68 f7 ff ff       	jmp    8010594c <alltraps>
...
801061e6:	6a 71                	push   $0x71
  jmp alltraps
801061e8:	e9 5f f7 ff ff       	jmp    8010594c <alltraps>
...
801061ef:	6a 72                	push   $0x72
  jmp alltraps
801061f1:	e9 56 f7 ff ff       	jmp    8010594c <alltraps>
...
801061f8:	6a 73                	push   $0x73
  jmp alltraps
801061fa:	e9 4d f7 ff ff       	jmp    8010594c <alltraps>
...
80106201:	6a 74                	push   $0x74
  jmp alltraps
80106203:	e9 44 f7 ff ff       	jmp    8010594c <alltraps>
...
8010620a:	6a 75                	push   $0x75
  jmp alltraps
8010620c:	e9 3b f7 ff ff       	jmp    8010594c <alltraps>
...
80106213:	6a 76                	push   $0x76
  jmp alltraps
80106215:	e9 32 f7 ff ff       	jmp    8010594c <alltraps>
...
8010621c:	6a 77                	push   $0x77
  jmp alltraps
8010621e:	e9 29 f7 ff ff       	jmp    8010594c <alltraps>
...
80106225:	6a 78                	push   $0x78
  jmp alltraps
80106227:	e9 20 f7 ff ff       	jmp    8010594c <alltraps>
...
8010622e:	6a 79                	push   $0x79
  jmp alltraps
80106230:	e9 17 f7 ff ff       	jmp    8010594c <alltraps>
...
80106237:	6a 7a                	push   $0x7a
  jmp alltraps
80106239:	e9 0e f7 ff ff       	jmp    8010594c <alltraps>
...
80106240:	6a 7b                	push   $0x7b
  jmp alltraps
80106242:	e9 05 f7 ff ff       	jmp    8010594c <alltraps>
...
80106249:	6a 7c                	push   $0x7c
  jmp alltraps
8010624b:	e9 fc f6 ff ff       	jmp    8010594c <alltraps>
...
80106252:	6a 7d                	push   $0x7d
  jmp alltraps
80106254:	e9 f3 f6 ff ff       	jmp    8010594c <alltraps>
...
8010625b:	6a 7e                	push   $0x7e
  jmp alltraps
8010625d:	e9 ea f6 ff ff       	jmp    8010594c <alltraps>
...
80106264:	6a 7f                	push   $0x7f
  jmp alltraps
80106266:	e9 e1 f6 ff ff       	jmp    8010594c <alltraps>
...
8010626d:	68 80 00 00 00       	push   $0x80
  jmp alltraps
80106272:	e9 d5 f6 ff ff       	jmp    8010594c <alltraps>
...
80106285:	68 82 00 00 00       	push   $0x82
  jmp alltraps
8010628a:	e9 bd f6 ff ff       	jmp    8010594c <alltraps>
...
80106291:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106296:	e9 b1 f6 ff ff       	jmp    8010594c <alltraps>
...
8010696d:	68 94 7b 10 80       	push   $0x80107b94
...
80106c5f:	68 d9 7b 10 80       	push   $0x80107bd9
...
80106dc9:	68 11 7c 10 80       	push   $0x80107c11
...
80106e2b:	68 29 7c 10 80       	push   $0x80107c29
...
80106f0c:	68 45 7c 10 80       	push   $0x80107c45
...
80106fe3:	68 56 7c 10 80       	push   $0x80107c56
...
801070c9:	68 7a 7c 10 80       	push   $0x80107c7a
801070ce:	e8 bd 92 ff ff       	call   80100390 <panic>
      panic("copyuvm: pte should exist");
801070d3:	83 ec 0c             	sub    $0xc,%esp
801070d6:	68 60 7c 10 80       	push   $0x80107c60
